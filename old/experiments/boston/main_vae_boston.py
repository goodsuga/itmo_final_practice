from generator_vae import TableDataGenerator
import pandas as pd
...
generator = TableDataGenerator(train_scaled, cat_idx, numeric_idx, all_cols, optuna_timeout_seconds=40, n_optuna_trials_per_column=5000, train_epochs=30_000)

generated = generator.generate(30_000)
...
generated["medv"] = generated["medv"].fillna(0.0)
print("Generated: ")
print(generated)
