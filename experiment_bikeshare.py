...
def run_bikeshare():
    ...
    res_gan.sort_values(by="r2", ascending=False).to_csv(out_gan / (str(uuid4()) + ".csv"), index=False)
    ...
    res_vae.sort_values(by="r2", ascending=False).to_csv(out_vae / (str(uuid4()) + ".csv"), index=False)
