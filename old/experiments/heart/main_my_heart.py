...
generator = TableDataGenerator(train_scaled, cat_idx, numeric_idx, all_cols, optuna_timeout_seconds=40, n_optuna_trials_per_column=5000, train_epochs=100_000)

generated = generator.generate(300_000)
